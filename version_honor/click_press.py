...
qianniu3_path = os.path.join(dir_path,'img','q3.png')

def to_click1():
    print('触发了')
    x, y = pyautogui.locateCenterOnScreen(qianniu3_path,region= (350, 1017,1076,59), confidence=0.9)
    pyautogui.click(x, y,duration=0.1)
    # print(x,y)

    pyautogui.click(x+172, y-108,duration=0.3)
    pyautogui.click(1319,691,duration=0.1)
